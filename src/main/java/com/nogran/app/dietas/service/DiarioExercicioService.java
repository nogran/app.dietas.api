...
import com.nogran.app.dietas.model.DiarioExercicio;
import com.nogran.app.dietas.model.Exercicio;
...
public class DiarioExercicioService {
  ...
  public void adicionarExercicio(Usuario usuario, Exercicio exercicio) {

    LocalDate hoje = LocalDate.now();

    DiarioExercicio diarioAtual =
        usuario.getDiarioExercicios().stream()
  ...
  public void mostrarResumoDeExercicios(Usuario usuario, LocalDate localDate) {
    List<DiarioExercicio> atividadesNaData =
        usuario.getDiarioExercicios().stream()
    ...
    if (atividadesNaData.isEmpty()) {
      ...
      System.out.println(
          "Resumo de Atividades de " + usuario.getNome() + " para " + localDate + ":");
